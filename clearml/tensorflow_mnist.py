...
def main():
    ...
    model_snapshots_path = 's3://192.168.56.253:9000/vsmodels/snapshots'
    ...
    task.set_base_docker("harbor.io/nvidia/tensorflow:19.11-tf2-py3 --env GIT_SSL_NO_VERIFY=true --env TRAINS_AGENT_GIT_USER=tkahsion --env TRAINS_AGENT_GIT_PASS=P@ssw0rd")
